# KamiYomu Crawler Agent — MangaKatana

A dedicated crawler agent for accessing public manga data from MangaKatana. Built on `KamiYomu.CrawlerAgents.Core`, this agent enables efficient search, metadata extraction, and integration with the KamiYomu platform.

## Features
- Search public MangaDex content (titles, authors, tags)
...
The package is published as `KamiYomu.CrawlerAgents.MangaKatana`.
...
- Navigate to `/src/KamiYomu.CrawlerAgents.MangaKatana/`
- Double-click `KamiYomu.CrawlerAgents.MangaKatana.sln`
...
- VS Code: Terminal > `dotnet build src/KamiYomu.CrawlerAgents.MangaKatana/KamiYomu.CrawlerAgents.MangaKatana.sln`
